      ...
      <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
        ...
        <div className="w-full lg:w-3/4">
          <div className="grid md:grid-cols-2 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8">
            {/* First Card */}
            <div className="col-span-3 md:col-span-1.5 border-solid border-2 border-black-600 bg-[#F5F5F7]/90 rounded-[35px] h-[532px] w-auto shadow-3x1 p-2 items-center flex flex-col justify-center hover:-translate-y-4 transition-all duration-300 drop-shadow-2xl">
            ...
            {/* Second Card */}
            <div className="border-solid border-2 border-black-600 bg-[rgba(255,255,255,0.04)] rounded-[35px] h-auto shadow-3x1 sm:w-[416px] p-8 items-center flex flex-col justify-center hover:-translate-y-4 transition-all duration-300 drop-shadow-2xl">
              <h3 className="text-[28px] font-semibold text-[#ffff] mx-5 text-center mt-2">
            ...
            <div
              className="border-solid border-2 border-black-600 bg-[rgba(255,255,255,0.04)] rounded-[35px] sm:h-[412px] sm:w-[416px] shadow-3x1 p-8 flex justify-center items-center hover:-translate-y-4 transition-all duration-300 bg-gradient-to-r from-[#6D58C6] to-[#CC76E2] drop-shadow-2xl"
        ...
        {/* Right div */}
        <div className="border-solid border-2 border-black-600 bg-[rgba(255,255,255,0.04)] rounded-[35px] h-100 shadow-3x1">
          <div className="m-5 rounded-[35px] border-dashed border-2 border-white">
